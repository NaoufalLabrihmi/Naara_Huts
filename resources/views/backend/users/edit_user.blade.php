    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <form id="myForm" action="{{ route('user.update')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset('upload/user_images/'.$user->photo) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                                    </div>
                                </div>
