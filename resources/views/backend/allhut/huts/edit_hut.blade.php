                    ...
                    <div class="card-body">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#primaryhome" role="tab" aria-selected="true">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="tab-title">Manage Hut</div>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#primaryprofile" role="tab" aria-selected="false" tabindex="-1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="tab-title">Hut Number</div>
                                    </div>
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content py-3">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" action="{{ route('update.hut', $editData->id) }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input name="total_adult" type="text" class="form-control" id="input2" value="{{$editData->total_adult}}">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="input2" class="form-label">Total Child</label>
                                                    <input name="total_child" type="text" class="form-control" id="input2" value="{{$editData->total_child}}">
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="description" class="form-control" id="editor">{!! $editData->description !!}</textarea>
                                                </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="basic_facility_section_remove" id="basic_facility_section_remove">
                                                            <div class="row add_item">
                                                                <div class="col-md-8">
                                                                    <label for="facility_name" class="form-label"> Hut Facilities </label>
                                                        ...
                                                        <div class="basic_facility_section_remove" id="basic_facility_section_remove">
                                                            <div class="row add_item">
                                                                <div class="col-md-6">
                                                                    <label for="basic_facility_name" class="form-label">Hut Facilities </label>
                            ...
                            <div class="tab-pane fade" id="primaryprofile" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        <a class="card-title btn btn-primary float-right" onclick="addHutNo()" id="addHutNo">
                                            <i class="lni lni-plus">Add New</i>
                                        </a>
                                        <div class="hutnoHide" id="hutnoHide">
                                            <form action="{{ route('store.hut.no',$editData->id) }}" method="post">
                                                @csrf
                                                <input type="hidden" name="hut_type_id" value="{{ $editData->huttype_id }}">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="input2" class="form-label">Hut No </label>
                                                        <input type="text" name="hut_no" class="form-control" id="input2">
                                                    </div>
                                        ...
                                        <table class="table mb-0 table-striped" id="hutview">
                                            <thead>

                                                <tr>
                                                    <th scope="col">Hut Number</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->status }}</td>
                                                    <td>
                                                        <a href="{{ route('edit.hutno',$item->id) }}" class="btn btn-warning px-3 radius-30"> Edit</a>
                                                        <a href="{{ route('delete.hutno',$item->id) }} " class="btn btn-danger px-3 radius-30" id="delete"> Delete</a>
            ...
            <div class="container mt-2">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="basic_facility_name">Hut Facilities</label>
                        <select name="facility_name[]" id="basic_facility_name" class="form-control">
                            <option value="">Select Facility</option>
                            <option value="Complimentary Breakfast">Complimentary Breakfast</option>
                            <option value="32/42 inch LED TV"> 32/42 inch LED TV</option>
