...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Hut List</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Add Hut List</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('store.hutlist') }}" class="row g-3">
                                @csrf
                                <div class="col-md-4">
                                    <label for="huttype_id" class="form-label">Hut Type</label>
                                    <select name="hut_id" id="hut_id" class="form-select">
                                        <option selected="">Select Hut Type </option>
                                        @foreach ($huttype as $item)
                                        <option value="{{ $item->hut->id }}" {{ collect(old('huttype_id'))->contains($item->id) ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="input3" class="form-label">Hut</label>
                                    <input type="number" name="number_of_huts" class="form-control">
