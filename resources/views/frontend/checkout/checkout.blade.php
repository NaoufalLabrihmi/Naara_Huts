                        ...
                        <div class="card-body">
                            <div class="billing-details">
                                ...
                                <div style="display: flex">
                                    <img style="height:100px; width:120px;object-fit: cover" src=" {{(!empty($hut->image))? url('upload/hutimg/'.$hut->image) : url('upload/no_img.jpg')}} " alt="Images" alt="Images">
                                    <div style="padding-left: 10px;">
                                        <a href="  " style="font-size: 20px; color: #595959;font-weight: bold">{{@$hut->type->name}}</a>
                                        <p><b>{{@$hut->price}}$ / Night</b></p>
                                    </div>
                                ...
                                <table class="table" style="width: 100%">
                                    @php
                                    $subtotal = $hut->price * $nights * $book_data['number_of_huts'];
